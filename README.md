...
**Phase 3 完了（M26〜M31）。** Phase 0（M0〜M12）／Phase 1（M13〜M16）／Phase 2（M17〜M20）／
Phase 2.5（保持設計 M21〜M25）／M25.5（権限境界）まで済み。2026-09-01にリポジトリ作成。

次は Phase 4（チャートとグラフビュー、`.base` からの離脱）。
