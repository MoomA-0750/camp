...
**Phase 3 完了（M26〜M31）＋ outer gate・実ブラウザでの確認まで（2026-09-07）。**Phase 0〜2、Phase 2.5（保持設計、M21〜M25）、M25.5（権限境界）は済み。2026-09-01にリポジトリ作成。
...
- campd を入れ替えても、走っているセッションは引き取り直す。実行面が落ちると子も終わる
