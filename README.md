...
**Phase 3.5 完了（SSH経由のリモート起動）＋ 本物の sshd での outer gate まで（2026-09-11）。**Phase 0〜3、Phase 2.5（保持設計、M21〜M25）、M25.5（権限境界）は済み。2026-09-01にリポジトリ作成。
